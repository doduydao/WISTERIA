...
def evaluate(
    ...
    - TDD/TBD/MATRES: harmonic mean F1.
    ...
    if is_I2B2:
        ...
        if test_df is not None:
            ...
            print(f"n_gold_closure:  {n_gold_closure}")
            print(f"n_pred_closure:  {n_pred_closure}")
            print("==============================================")
        ...
        # Nếu KHÔNG có test_df → fallback logic cũ
        else:
    ...
    if is_TBD or is_MATRES:
        ...
        precisions, recalls, f1s, _ = precision_recall_fscore_support(
            all_labels, all_predictions, average=None)
        print(f"[TBD/MATRES] Accuracy={acc:.4f}, F1={f1:.4f}, P={p:.4f}, R={r:.4f}")
    ...
    if is_TDD:
        ...
        print(f"[TDD] F1={F1:.4f}, P={P:.4f}, R={R:.4f}")
...
def train_model(model,
    ...
    for epoch in range(num_epochs):
        ...
        # Evaluate định kỳ theo từng dataset flag
